...
# Installation
LifelongLEGOS follows the integration guidelines described [here](https://docs.nerf.studio/en/latest/developer_guides/new_methods.html) for custom methods within Nerfstudio. 
...
### 1. Clone this repo
`git clone https://github.com/BerkeleyAutomation/LifelongLEGOS`
...
- Launch training with `ns-train lllegos --data <data_folder>`. This specifies a data folder to use. For more details, see [Nerfstudio documentation](https://docs.nerf.studio/en/latest/quickstart/first_nerf.html). 
